...
description: Run one repeatable daily cycle that collects three current AI/ML/CS papers and three news issues, saves the dated digest, shows the result in chat, commits only that cycle's changes, and pushes the commit with git push origin master.
---
