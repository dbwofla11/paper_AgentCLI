...
API가 막히거나 결과가 빈약하면 WebSearch → WebFetch로 보완한다. 허용된 도메인은 `.claude/settings.json` 참고 (arXiv, Semantic Scholar, OpenAlex, OpenReview, ACL Anthology, PMLR, NeurIPS Proceedings, CVF, DBLP).
